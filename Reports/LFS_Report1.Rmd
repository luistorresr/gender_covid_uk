...
This report draws on the analysis of the 2020/21 releases of the UK Labour Force Survey (LFS). Respondents are interviewed for 5 successive waves at 3-monthly intervals and approximately 20% of the sample is replaced every quarter. In 2020, additional non-calendar quarter data have been released as a response to the need of data in the context of the coronavirus pandemic.
...
When age groups are considered, the unemployment trend shows concerning levels for people between 18 and 24 years old. Unemployment reached 20% for men in summer 2020. Although employment showed signed of recovery after this peak, signs are fading for men, but recovery remains constant for women. Continue. 
